...
uint256 hashGenesisBlock("0x61d521b1bd392f052cd2e2a49efa07f68794036b8836b6d236311d7aaefb7c2b");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 420000); // Technocoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // Technocoin: 3.5 days
static const int64 nTargetSpacing = 2 * 60; // Technocoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbb197110120ce7de5d85478721c4e6103d9a7ed23aabb06e977abca2bb4ec1f8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = " 12/dec/2022  M.HamzaAshfaq made his own crypto coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0459fb4ef78b189a3c7de002d9d9959a05df178e9aa7e365e6d181af1fbcc74ad9d4b7d13163540052ebf613128af667ce3ce8049972501f024d57983b2fc83f73") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1670838501;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084959487;

        if (fTestNet)
        {
            block.nTime    = 1670838399;
            block.nNonce   = 385489074;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x31a8e8a0937d1f90b2a709e12a81aae31e98775ecbf72c71d0d20d4394fd32d0"));
        block.print();
